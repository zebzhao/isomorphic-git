          ...
          for (let diff of mergeDiff) {
            ...
            switch (diff.status) {
              ...
              case 'conflict':
                ...
                let merged = await merge(ours.content, base.content, theirs.content);
...
export { utils, E, add, addRemote, annotatedTag, branch, checkout, clone, commit, config, currentBranch, deleteBranch, deleteRef, deleteRemote, deleteTag, expandOid$1 as expandOid, expandRef, fetch, findMergeBase, findRoot, getRemoteInfo, indexPack, init, isDescendent, listBranches, listCommitsAndTags, listFiles, listRemotes, listTags, log$1 as log, merge$1 as merge, pull, push, readObject$1 as readObject, remove, resetIndex, resolveRef, sign, status, statusMatrix, tag, verify, version, walkBeta1, writeObject$1 as writeObject, writeRef, WORKDIR, STAGE, TREE, plugins, cores };
