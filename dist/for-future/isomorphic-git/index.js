...
export { E, STAGE, TREE, WORKDIR, add, addRemote, annotatedTag, branch, checkout, clone, commit, config, cores, currentBranch, deleteBranch, deleteRef, deleteRemote, deleteTag, expandOid$1 as expandOid, expandRef, fetch, findMergeBase, findRoot, getOidAtPath, getRemoteInfo, hashBlob, indexPack, init, isDescendent, listBranches, listCommitsAndTags, listFiles, listRemotes, listTags, log$1 as log, merge, packObjects, plugins, pull, push, readObject$1 as readObject, remove, resetIndex, resolveRef, sign, status, statusMatrix, tag, utils, verify, version, walkBeta1, writeObject$1 as writeObject, writeRef };
